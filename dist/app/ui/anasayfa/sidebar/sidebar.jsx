...
import { MdDashboard, MdAssignmentInd, MdHomeWork, MdLogout, } from "react-icons/md";
import Link from "next/link";
import { Button } from "@/components/ui/button";
export default function Sidebar() {
    return (<div className="flex h-[100vh] flex-col items-center justify-between rounded-xl border p-7">
